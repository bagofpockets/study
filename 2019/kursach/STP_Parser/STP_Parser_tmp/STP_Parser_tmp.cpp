// STP_Parser_tmp.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
public:
	...
	void print_data()
	{
		...
		std::vector<CONICAL_SURFACE*> vc = CONICAL_SURFACE_sorter();
